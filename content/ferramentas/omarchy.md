...
tags:
  ...
  - linux
  - wayland
description: Distribuição Arch Linux opinada com Hyprland — meu ambiente diário
lang: pt-br
enableToc: true
aliases: []
---
...
- **wm**: Hyprland — Wayland, suave, animações fluidas
- **shell**: barra própria com plugins modularizados
- **temas**: sistema de temas integrado com hot-reload
